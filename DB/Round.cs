...
{
	internal static readonly Round Empty = new ();
	...
	internal bool Workable => Number == (Tournament.Rounds.Length is 0 ? default : Tournament.Rounds.Max(static round => round.Number))
	...
	internal double PreRoundScore(GamePlayer gamePlayer)
		=> PriorGameScores(gamePlayer).Sum();

	internal double PreRoundScore(Player player)
