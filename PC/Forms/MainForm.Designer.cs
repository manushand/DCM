namespace PC.Forms
{
	internal sealed partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			TournamentToolStripMenuItem.Size = new Size(48, 20);
			...
			ShowTimingToolStripMenuItem.Size = new Size(144, 22);
			...
			EmailConfigurationToolStripMenuItem.Size = new Size(144, 22);
			...
			DatabaseToolStripMenuItem.Size = new Size(144, 22);
			...
			AccessToolStripMenuItem.Size = new Size(139, 22);
			AccessToolStripMenuItem.Text = "&Access";
			//
			// AccessOpenToolStripMenuItem
			//
			AccessOpenToolStripMenuItem.Name = "AccessOpenToolStripMenuItem";
			AccessOpenToolStripMenuItem.Size = new Size(139, 22);
			...
			SaveAsDatabaseToolStripMenuItem.Size = new Size(139, 22);
			...
			CheckDatabaseToolStripMenuItem.Size = new Size(139, 22);
			...
			SqlServerToolStripMenuItem.Size = new Size(139, 22);
			...
			ClearDatabaseToolStripMenuItem.Size = new Size(139, 22);
			...
			ReportsConfigurationToolStripMenuItem.Size = new Size(144, 22);
			ReportsConfigurationToolStripMenuItem.Text = "&Reports…";
			//
			// MainFormMenuStrip
			//
			MainFormMenuStrip.ImageScalingSize = new Size(40, 40);
			MainFormMenuStrip.Items.AddRange(new ToolStripItem[] { PlayersToolStripMenuItem, GroupToolStripMenuItem, TournamentToolStripMenuItem, ScoringToolStripMenuItem, ConfigurationMenuItem, HelpToolStripMenuItem });
			...
			HelpTopicsToolStripMenuItem.Size = new Size(117, 22);
			...
			HelpAboutToolStripMenuItem1.Size = new Size(117, 22);
