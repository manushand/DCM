...
internal sealed partial class GroupRatingsForm : Form
{
														...
														EventArgs? e = null)
	{
		...
		var ratings = Group.Players
						   ...
						   .ToList();
		ratings.ForEach(rated => rated.Rank = ratings.Count(ratingInfo => ratingInfo.Rating > rated.Rating) + 1);
		RatingsDataGridView.FillWith(ratings);
