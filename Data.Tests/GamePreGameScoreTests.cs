...
public sealed class GamePreGameScoreTests
{
	...
	public void PreGameScore_Event_Uses_PreRoundScore()
	{
		...
		var gNow = new Game { Id = 200, Round = r2, Status = Game.Statuses.Seeded, Date = new DateTime(2024,2,1), Number = 1 };
	...
	public void PreGameScore_Group_Uses_Group_RatePlayer()
	{
		...
		SetNonPublic(hostRound, "TournamentId", t.Id); SetPrivate(hostRound, "<Tournament>k__BackingField", t);
		...
		var gA = new Game { Id = 300, Round = r1, Status = Game.Statuses.Finished, Scored = true, Date = new DateTime(2024,1,1), Number = 1 };
		var gB = new Game { Id = 301, Round = r2, Status = Game.Statuses.Finished, Scored = true, Date = new DateTime(2024,1,15), Number = 1 };
		...
		var gNow = new Game { Id = 400, Round = r2, Status = Game.Statuses.Seeded, Date = new DateTime(2024,2,1), Number = 2 };
